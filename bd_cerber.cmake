...
elseif(APPLE)
	...
	if(MAYA_VERSION VERSION_GREATER_EQUAL 2022)
		set(CERBER_INSTALL_ROOT "${WITH_CERBER_ROOT}/cerber-libs/linux/gcc-9.3/${CERBER_INSTALL_SUBDIR}")
	else()
...
if(WIN32)
	...
	if(MAYA_VERSION VERSION_GREATER_EQUAL 2022)
		set(CERBER_PROTECT "${WITH_CERBER_DATA_ROOT}/bin/gcc-9.3/cerberProtect.bin")
	else()
